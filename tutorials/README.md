...
| 07_Conditional-Schemas      | Demonstrates how to use conditional schemas (v2.0+)         | [👁️](https://nbviewer.org/github/BardiaKh/RadPrompter/blob/main/tutorials/07_Conditional-Schemas/07_Conditional-Schemas.ipynb) [📓](./07_Conditional-Schemas) |
